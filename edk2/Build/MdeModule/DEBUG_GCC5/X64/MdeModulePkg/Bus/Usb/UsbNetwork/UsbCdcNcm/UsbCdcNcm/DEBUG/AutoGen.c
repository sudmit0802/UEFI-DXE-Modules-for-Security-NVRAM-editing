...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x52230d31, 0x6c11, 0x4442, {0xb2, 0x62, 0xbe, 0xc6, 0xbf, 0xe8, 0x4e, 0xfa}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "UsbCdcNcm";
...
{
  return UsbNcmEntry (ImageHandle, SystemTable);
}
