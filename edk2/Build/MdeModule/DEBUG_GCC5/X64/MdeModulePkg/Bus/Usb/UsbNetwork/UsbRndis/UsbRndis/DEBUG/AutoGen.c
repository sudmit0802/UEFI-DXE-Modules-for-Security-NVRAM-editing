...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x11E32C34, 0x60B5, 0x4991, {0x8D, 0xEA, 0x63, 0xD3, 0xE8, 0xC8, 0x76, 0xDE}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "UsbRndis";
...
{
  return UsbRndisEntry (ImageHandle, SystemTable);
}
