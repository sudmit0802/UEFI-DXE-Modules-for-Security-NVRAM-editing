...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xca6eb4f4, 0xf1d6, 0x4375, {0x97, 0xd6, 0x18, 0x85, 0x68, 0x71, 0xe1, 0xbf}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "NetworkCommon";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEdkIIUsbEthProtocolGuid = { 0x8d8969cc, 0xfeb0, 0x4303, { 0xb2, 0x1a, 0x1f, 0x11, 0x6f, 0x38, 0x56, 0x43 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdEnableUsbNetworkRateLimiting = _PCD_VALUE_PcdEnableUsbNetworkRateLimiting;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdUsbNetworkRateLimitingCredit = _PCD_VALUE_PcdUsbNetworkRateLimitingCredit;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdUsbNetworkRateLimitingFactor = _PCD_VALUE_PcdUsbNetworkRateLimitingFactor;
...
{
  return NetworkCommonEntry (ImageHandle, SystemTable);
}
