...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x07a84945, 0x685d, 0x48ec, {0xa6, 0xa1, 0x1b, 0x39, 0x75, 0x79, 0xfa, 0x76}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "UsbCdcEcm";
...
{
  return UsbEcmEntry (ImageHandle, SystemTable);
}
