...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xAC7884C7, 0x35A2, 0x40AC, {0xB9, 0xE0, 0xAD, 0x67, 0x29, 0x8E, 0x3B, 0xBA}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SpiNorFlashJedecSfdpSmm";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEdk2JedecSfdpSpiSmmDriverGuid = { 0x95A1E915, 0x195C, 0x477C, { 0x92, 0x6F, 0x7E, 0x24, 0x67, 0xC1, 0xB3, 0x1F }};
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiSpiSmmNorFlashProtocolGuid = { 0xaab18f19, 0xfe14, 0x4666, { 0x86, 0x04, 0x87, 0xff, 0x6d, 0x66, 0x2c, 0x9a }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdSpiNorFlashOperationRetryCount = _PCD_VALUE_PcdSpiNorFlashOperationRetryCount;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdSpiNorFlashFixedTimeoutRetryCount = _PCD_VALUE_PcdSpiNorFlashFixedTimeoutRetryCount;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdSpiNorFlashOperationDelayMicroseconds = _PCD_VALUE_PcdSpiNorFlashOperationDelayMicroseconds;
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (SpiNorFlashJedecSfdpSmmEntry (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
