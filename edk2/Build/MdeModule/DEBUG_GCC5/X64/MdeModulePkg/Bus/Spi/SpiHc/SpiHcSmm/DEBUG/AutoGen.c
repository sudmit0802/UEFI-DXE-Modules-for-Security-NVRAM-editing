...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0CDAE298, 0xCB3B, 0x480A, {0xBD, 0xC4, 0xA6, 0x84, 0x0F, 0xFE, 0x1F, 0x5E}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SpiHcSmm";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiSpiSmmHcProtocolGuid = { 0xe9f02217, 0x2093, 0x4470, { 0x8a, 0x54, 0x5c, 0x2c, 0xff, 0xe7, 0x3e, 0xcb }};
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (SpiHcProtocolEntry (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
