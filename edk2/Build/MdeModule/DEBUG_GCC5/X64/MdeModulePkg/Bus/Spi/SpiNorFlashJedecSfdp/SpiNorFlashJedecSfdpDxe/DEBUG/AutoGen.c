...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0DC9C2C7, 0xD450, 0x41BA, {0x9C, 0xF7, 0xD2, 0x09, 0x0C, 0x35, 0xA7, 0x97}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SpiNorFlashJedecSfdpDxe";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEdk2JedecSfdpSpiDxeDriverGuid = { 0xBE71701E, 0xB63C, 0x4574, { 0x9C, 0x5C, 0x36, 0x29, 0xE8, 0xEA, 0xC4, 0x14 }};
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiSpiNorFlashProtocolGuid = { 0xb57ec3fe, 0xf833, 0x4ba6, { 0x85, 0x78, 0x2a, 0x7d, 0x6a, 0x87, 0x44, 0x4b }};
...
{
  return SpiNorFlashJedecSfdpDxeEntry (ImageHandle, SystemTable);
}
