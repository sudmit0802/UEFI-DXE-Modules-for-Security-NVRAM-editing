...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x95D148FF, 0x5A23, 0x43B9, {0x9F, 0xC4, 0x80, 0xAE, 0x0D, 0xD4, 0x8D, 0x32}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SpiHcDxe";
...
{
  return SpiHcProtocolEntry (ImageHandle, SystemTable);
}
