...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xCD660A87, 0x454B, 0x4346, {0xA3, 0x5C, 0x3D, 0x89, 0xBF, 0x8E, 0xCF, 0xAF}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MmVariablePei";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiPeiMmCommunicationPpiGuid = { 0xae933e1c, 0xcc47, 0x4e38, { 0x8f, 0xe, 0xe2, 0xf6, 0x1d, 0x26, 0x5, 0xdf } };
...
{
  return PeiMmVariableInitialize (FileHandle, PeiServices);
}
