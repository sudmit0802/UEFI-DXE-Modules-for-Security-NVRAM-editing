...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x4057a7a8, 0x4baa, 0x49f9, {0x84, 0x95, 0x1c, 0x8a, 0x37, 0xd5, 0x8d, 0xa5}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "hook";
...
{
  return HookDxeEntryPoint (ImageHandle, SystemTable);
}
